...
<?php } ?>
<h2 style="text-align: center;">Master User Siswa & Pengajar</h2>
<table id="table-sism">
    <thead>
        <tr>
            <th>#</th>
    ...
    <?php while($row = mysql_fetch_array($query)) { ?>
        <?php if($counter%2 == 0) { ?><tr class="alt"><?php } else { ?><tr><?php } ?>
            ...
            <td><a href="index.php?page=ubahusersiswapengajar&id=<?php echo $row['id_user']; ?>" title="Ubah Data">EDIT</a></td>
        </tr>
    <?php } ?>
    <?php } ?>
    </tbody>
